...
int main()
{
    ...
    Shader ourShader("E:/vstudioproject/LearnOpenGL/LearnOpenGL/vertexShaderSource_Texture4.GLSL", "E:/vstudioproject/LearnOpenGL/LearnOpenGL/fragmentShaderSource_Texture4.GLSL");
    ...
    if (data)
    {
        ...
        std::cout << "Texture loaded successfully: container.jpg" << std::endl;
    }
    else
    {
    ...
    if (data)
    {
        ...
        glGenerateMipmap(GL_TEXTURE_2D);
        std::cout << "Texture loaded successfully: awesomeface.png" << std::endl;
    }
    else
    {
