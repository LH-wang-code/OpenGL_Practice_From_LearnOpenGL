...
int main()
{
...
#endif
	GLFWwindow* window = glfwCreateWindow(800, 600, "Learn Materials", nullptr, nullptr);
	if (window == nullptr)
	{
	...
	{
		std::cout << "ERROR::Failed to initlize GLAD" << std::endl;
		return -1;
	}
	...
	Shader lightingShader("E:/vstudioproject/LearnOpenGL/LearnOpenGL/vertexShaderSource_materials.GLSL", "E:/vstudioproject/LearnOpenGL/LearnOpenGL/fragmentShaderSource_materials.GLSL");
